...
- Code for this example is available here [arima.R](codes/autocorrelation.R)
...
```r
# Load and save data
prices <- read.table(file = "stock_gold.txt", header = TRUE)
stock.price <- prices$stock_price
gold.price <- prices$gold_price
...
```{r}
# Load and save data
prices <- read.table(file = "datasets/stock_gold.txt", header = TRUE)
stock.price <- prices$stock_price
gold.price <- prices$gold_price
