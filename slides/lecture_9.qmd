...
# Lecture 9: <br>  Model Selection & <br> Regression <br> Assumptions I {background-color="#cc0164" visibility="uncounted"}
...
## Example 3: Checking the statistical analysis {.smaller}
...
- The article suggests that the second year of marriage is when divorce risk is highest 
- Here, we take a moment to look at the statistical evidence behind this claim
...
- In Lectures 7-8 we presented 4 methods to assess linear models 
...
- Left: Residual plot for original model: $\qquad y = \alpha + \beta x + \e$
- Right: Residual plot for $\log$ model: $\, \qquad \quad \log y = \alpha + \beta x + \e$
...
- Left: Histogram of residuals for original model: $\qquad y = \alpha + \beta x + \e$
- Right: Histogram of residuals for $\log$ model: $\, \qquad \quad \log y = \alpha + \beta x + \e$
...
- For Stock Price of $1.2$, the model predicts Gold Price of $4.182198$
- $95\%$ confidence interval for the predicted Gold Price is $[2.492211, 7.018178]$
