...
4. The t-test in R
5. One-sample variance ratio test
6. Worked example
7. One-sample variance ratio test in R
...
# Part 4: <br>The t-test in R {background-color="#cc0164" visibility="uncounted"}
...
# Part 5: <br>One-sample variance <br> ratio test{background-color="#cc0164" visibility="uncounted"}
...
# Part 6: <br>Worked example {background-color="#cc0164" visibility="uncounted"}
...
# Part 7: <br>One-sample variance <br> ratio test in R{background-color="#cc0164" visibility="uncounted"}
