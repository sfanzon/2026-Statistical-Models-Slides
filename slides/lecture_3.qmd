...
2. Vectors
3. The t-test in R
4. One-sample variance ratio test
5. Worked example
6. One-sample variance ratio test in R
...
# Part 3: <br>The t-test in R {background-color="#cc0164" visibility="uncounted"}
...
# Part 4: <br>One-sample variance <br> ratio test{background-color="#cc0164" visibility="uncounted"}
...
# Part 5: <br>Worked example {background-color="#cc0164" visibility="uncounted"}
...
# Part 6: <br>One-sample variance <br> ratio test in R{background-color="#cc0164" visibility="uncounted"}
...
# Part 7: <br>Graphics in R {background-color="#cc0164" visibility="uncounted"}
...
# Part 8: <br>Functions in R {background-color="#cc0164" visibility="uncounted"}
...
# Part 9: <br>More on Vectors {background-color="#cc0164" visibility="uncounted"}
