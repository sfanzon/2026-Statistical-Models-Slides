...
# Lecture 5: <br> Two-samples F-test & <br> Goodness-of-fit test   {background-color="#cc0164" visibility="uncounted"}
...
$$
\chi_p^2 = Z_1^2 + \ldots + Z_p^2  \qquad \text{where} \qquad  Z_1, \ldots, Z_p \,\,\, \text{iid} \,\,\, N(0, 1)
$$
...
\begin{align*}
  ...
  s^2_Y & = \frac{\sum_{i=1}^m y_i^2 - m \bar{y}^2}{m - 1} 
          = \frac{35783-13(51.6154)^2}{12} = 95.7564
\end{align*}
...
- Notice that
$$
s^2_Y = 95.7564 > 90.2778 = s_X^2
$$

- Hence the $F$-statistic is
$$
F = \frac{s^2_Y}{s_X^2} = \frac{95.7564}{90.2778} = 1.061\ \quad (3\ \text{d.p.})
$$
...
# Part 6: <br>Goodness-of-fit test for <br >Contingency tables {background-color="#cc0164" visibility="uncounted"}
